...
namespace Fitbit.Api.Portable
{
    public class FitbitClient : IFitbitClient
    {
        ...
        public FitbitClient(IAuthorization authorization, params IFitbitClientInterceptor[] interceptors)
        {
            ...
            var handlerPipeline = FitbitClientHelperExtensions.CreatePipeline(authorization, interceptors);

            HttpClient = new HttpClient(handlerPipeline);
        }
        ...
        /// <summary>
        /// Pass a freeform url. Good for debuging purposes
        /// </summary>
        /// <param name="date"></param>
        /// <param name="encodedUserId"></param>
        /// <returns></returns>
